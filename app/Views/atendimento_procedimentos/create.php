...
<div class="app-container">
    ...
    <main class="main-content">
        <div class="main-container">
            <!-- Header -->
            <div class="header">
                <h1><i class="bi bi-plus-circle"></i> Adicionar Procedimento ao Atendimento</h1>
                <p class="subtitle">Vincular procedimento realizado ao atendimento</p>
            </div>
                ...
                <form id="procedimentoForm" action="/atendimento-procedimentos/store" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="id_procedimento" name="id_procedimento" required>
                                    ...
                                    <?php foreach ($procedimentos as $procedimento): ?>
                                        <?php if (!in_array($procedimento['id_procedimento'], $procedimentosJaAdicionados)): ?>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="observacao" name="observacao" rows="3"
                                  placeholder="Observações sobre o procedimento realizado..."></textarea>
                        <div class="invalid-feedback"></div>
                    </div>

                    <?php if (!empty($procedimentosJaAdicionados)): ?>
                        <div class="alert alert-warning">
                            <h6><i class="bi bi-exclamation-triangle"></i> Procedimentos já adicionados</h6>
                            <p class="mb-0">Este atendimento já possui alguns procedimentos vinculados. Apenas procedimentos não vinculados estão disponíveis para seleção.</p>
                        </div>
                    <?php endif; ?>
